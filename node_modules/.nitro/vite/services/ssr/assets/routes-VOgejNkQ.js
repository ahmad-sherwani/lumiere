import { t as hero } from "./routes-B9kAWa_j.js";
import { useEffect, useRef, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import "firebase/firestore";
import { ArrowRight, Camera, Clock, Coffee, Eye, Heart, Image, Instagram, Mail, MessageCircle, Mic, Package, Play, Shirt, Sparkles, Star, TrendingUp, Zap } from "lucide-react";
//#region src/assets/user/Snapchat-926854658.jpg
var Snapchat_926854658_default = "/assets/Snapchat-926854658-BbEWZTpW.jpg";
//#endregion
//#region src/assets/user/Snapchat-666437094.jpg
var Snapchat_666437094_default = "/assets/Snapchat-666437094-DEl8LIdD.jpg";
//#endregion
//#region src/assets/user/20260418_213558.jpg
var _20260418_213558_default = "/assets/20260418_213558-BjYQuoF2.jpg";
//#endregion
//#region src/assets/user/20260407_233824.jpg
var _20260407_233824_default = "/assets/20260407_233824-CkXcCYCc.jpg";
//#endregion
//#region src/assets/user/Snapchat-670641198.jpg
var Snapchat_670641198_default = "/assets/Snapchat-670641198-CSouZXcw.jpg";
//#endregion
//#region src/assets/user/20251231_185953.jpg
var _20251231_185953_default = "/assets/20251231_185953-C4KbObGJ.jpg";
//#endregion
//#region src/assets/user/IMG-20260417-WA0160.jpg
var IMG_20260417_WA0160_default = "/assets/IMG-20260417-WA0160-fEKPMfmT.jpg";
//#endregion
//#region src/assets/user/IMG-20251225-WA0171.jpg
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: "Lumière"
					}), /* @__PURE__ */ jsx("div", { className: "mt-3 h-px w-24 mx-auto bg-gradient-to-r from-transparent via-primary/60 to-transparent animate-pulse" })]
				})
			}),
			/* @__PURE__ */ jsx(Nav, {}),
			/* @__PURE__ */ jsx(Hero, {}),
...
function FloatingBlob({ className }) {
	return /* @__PURE__ */ jsx("div", { className: `pointer-events-none absolute rounded-full blur-3xl ${className}` });
}
function Hero() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsx(FloatingBlob, { className: "w-[420px] h-[420px] bg-blush/50 -top-20 -left-20 animate-float-slow" }),
			/* @__PURE__ */ jsx(FloatingBlob, { className: "w-[360px] h-[360px] bg-nude/40 top-1/3 -right-20 animate-float" }),
			/* @__PURE__ */ jsx(FloatingBlob, { className: "w-[280px] h-[280px] bg-accent/40 bottom-0 left-1/3 animate-float-slow" }),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-accent" }), " Faceless UGC · 2026"]
						}),
						/* @__PURE__ */ jsxs("h1", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("a", {
								...
								children: ["View Portfolio", /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 transition group-hover:translate-x-1" })]
							}), /* @__PURE__ */ jsx("a", {
								href: "#contact",
					...
					children: [
						/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-blush rounded-[3rem]" }),
						/* @__PURE__ */ jsx("img", {
							src: hero,
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: tags.map((t) => /* @__PURE__ */ jsx("button", {
						onClick: () => setFilter(t),
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: items.map((p, i) => /* @__PURE__ */ jsxs("figure", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-primary/60 via-primary/0 to-transparent opacity-70 group-hover:opacity-90 transition" }),
							/* @__PURE__ */ jsx("div", {
							...
							/* @__PURE__ */ jsx("button", {
								...
								children: /* @__PURE__ */ jsx("span", {
									...
									children: /* @__PURE__ */ jsx(Play, { className: "w-5 h-5 ml-0.5" })
								})
							}),
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: stats.map((s, i) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(s.icon, { className: "w-5 h-5 mx-auto text-primary" }),
						/* @__PURE__ */ jsx("div", {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: packages.map((p, i) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("ul", {
							...
							children: p.features.map((f) => /* @__PURE__ */ jsxs("li", {
								...
								children: [/* @__PURE__ */ jsx("span", { className: `mt-1.5 w-1.5 h-1.5 rounded-full ${p.featured ? "bg-accent" : "bg-primary"}` }), f]
							}, f))
						}),
						/* @__PURE__ */ jsxs("a", {
							href: "#contact",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("a", {
								...
								children: [/* @__PURE__ */ jsx(Mail, { className: "w-4 h-4 text-primary" }), /* @__PURE__ */ jsx("span", {
									className: "text-sm",
							...
							/* @__PURE__ */ jsxs("a", {
								...
								rel: "noreferrer",
								className: "glass rounded-2xl px-5 py-4 flex items-center gap-3 hover:bg-card transition",
								children: [/* @__PURE__ */ jsx(Instagram, { className: "w-4 h-4 text-primary" }), /* @__PURE__ */ jsx("span", {
									className: "text-sm",
							...
							/* @__PURE__ */ jsxs("a", {
								...
								rel: "noreferrer",
								className: "glass rounded-2xl px-5 py-4 flex items-center gap-3 hover:bg-card transition",
								children: [/* @__PURE__ */ jsx(MessageCircle, { className: "w-4 h-4 text-primary" }), /* @__PURE__ */ jsx("span", {
									className: "text-sm",
									children: "WhatsApp"
								})]
							})
